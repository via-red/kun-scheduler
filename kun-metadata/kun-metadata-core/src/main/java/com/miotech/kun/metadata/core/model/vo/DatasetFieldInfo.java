...
public class DatasetFieldInfo {
    ...
    public DatasetFieldInfo(Long id, String name, String type, Watermark highWatermark, String description,
                            Long notNullCount, Double notNullPercentage, Long distinctCount) {
        this.id = id;
        this.name = name;
        this.type = type;
