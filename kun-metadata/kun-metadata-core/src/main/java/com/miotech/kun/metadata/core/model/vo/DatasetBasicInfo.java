...
public class DatasetBasicInfo {
    ...
    public DatasetBasicInfo(Long gid, String name, String datasource, String database, String schema, String description,
                            String type, Watermark highWatermark, Watermark lowWatermark, List<String> owners, List<String> tags, Boolean deleted) {
        this.gid = gid;
        this.name = name;
